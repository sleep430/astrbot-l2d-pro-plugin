...
const DEFAULT_CHANNELS: IdleChannelConfig[] = [
  { parameterId: 'ParamAngleX', amplitude: 1.2, frequency: 0.18, seed: 11 },
  { parameterId: 'ParamAngleY', amplitude: 0.8, frequency: 0.2, seed: 23, breathSway: 0.25 },
  { parameterId: 'ParamAngleZ', amplitude: 0.6, frequency: 0.15, seed: 37 },
  { parameterId: 'ParamBodyAngleX', amplitude: 0.5, frequency: 0.12, seed: 53 },
  { parameterId: 'ParamBodyAngleY', amplitude: 0.4, frequency: 0.12, seed: 89, breathSway: 0.35 },
  { parameterId: 'ParamBodyAngleZ', amplitude: 0.4, frequency: 0.1, seed: 97 },
  { parameterId: 'ParamEyeBallX', amplitude: 0.04, frequency: 0.35, seed: 67 },
  { parameterId: 'ParamEyeBallY', amplitude: 0.03, frequency: 0.35, seed: 79 }
]
...
/** 待机活跃度默认值 */
export const DEFAULT_IDLE_ACTIVITY = 0.08
/** activity 对幅度的调制范围：0 → 0.15 倍，1 → 1 倍 */
const AMPLITUDE_SCALE_BASE = 0.15
const AMPLITUDE_SCALE_SPAN = 0.85
